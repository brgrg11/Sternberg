...
function pracInstruct1RoutineBegin(snapshot) {
  return async function () {
    ...
    pracInstruct1Components.forEach( function(thisComponent) {
...
function practInstructRoutineBegin(snapshot) {
  return async function () {
    ...
    practInstructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function mainInstructRoutineBegin(snapshot) {
  return async function () {
    ...
    mainInstructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
